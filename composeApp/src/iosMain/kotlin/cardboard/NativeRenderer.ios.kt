...
import cardboard.sdk.IosMetalDistortionRenderer
import cardboard.sdk.MetalDistortionRendererTarget
    ...
    private inner class MetalTextureVideo(
        ...
        override fun bind() {
            renderEncoder?.apply {
                ...
                if (output === null) {
                    if (item.status != AVPlayerItemStatusReadyToPlay) { return } // wait for item to be ready
